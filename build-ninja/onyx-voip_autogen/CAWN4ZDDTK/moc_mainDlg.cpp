...
template <> constexpr inline auto CmainDlg::qt_create_metaobjectdata<qt_meta_tag_ZN8CmainDlgE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<WINBOOL()>(54, 2, QMC::AccessPublic, 0x80000000 | 55),
        // Slot 'OnClose'
        ...
        // Slot 'OnDeviceChange'
        QtMocHelpers::SlotData<WINBOOL(UINT, DWORD_PTR)>(64, 2, QMC::AccessPublic, 0x80000000 | 55, {{
...
void CmainDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 29: { WINBOOL _r = _t->OnQueryEndSession();
        ...
        case 32: { WINBOOL _r = _t->OnDeviceChange((*reinterpret_cast<std::add_pointer_t<UINT>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<DWORD_PTR>>(_a[2])));
            if (_a[0]) *reinterpret_cast<WINBOOL*>(_a[0]) = std::move(_r); }  break;
