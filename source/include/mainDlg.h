...
public slots:
    ...
    void onRefreshLevels(int wParam = 0, int lParam = 0);
    void onRegState2(int code, QString* headerError);
    ...
    void OnRestart();
    void PostRestart();
    void OnPowerBroadcast(WPARAM wParam, LPARAM lParam = 0);
    ...
    void onPlayerStop(int wParam = 0, int lParam = 0);
    void onCommandLine(const QString& params);
    void OnAccount(WPARAM wParam = 0, LPARAM lParam = 0);
